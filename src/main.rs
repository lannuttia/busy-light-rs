...
fn main() {
    ...
    .arg(clap::Arg::with_name("id-scope")
    ...
    .arg(clap::Arg::with_name("primary-key")
    ...
    simplelog::CombinedLogger::init(
        vec![
            simplelog::TermLogger::new(level_filter, simplelog::Config::default(), simplelog::TerminalMode::Mixed).unwrap()
        ]
    ).unwrap();
}
